...
seqiplot(mvad.seq, withlegend='right', ytlab=seq_dbt_3$Year, cpal = color, ylas=1, cex.legend=0.7, ncol=1, ylab = "Years", xlab = "Ressources", title='Sequence of the course identified as N°3 over the years')
