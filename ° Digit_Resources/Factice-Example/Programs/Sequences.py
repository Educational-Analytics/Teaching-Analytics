...
#######################
"""
Prepared_Sequence = pd.DataFrame(columns=['Course_ID', 'Year', 'Course_Digit_Duration', 'Resources_Amount', 'Resources_Rank', 'Resources_Type_Basic', 'Resources_Type_Advanced'])
for num in range(len(Sequences_8_30)):
    ...
    for basic,advanced in zip(list_basic, list_advanced):
        Prepared_Sequence = Prepared_Sequence.append({
            ...
            'Resources_Amount': Sequences_8_30.iloc[num]['Number_Resources'],
            'Resources_Rank': count, 
            'Resources_Type': basic}, 
            'Resources_Type': advanced}, ignore_index=True)
        count += 1
"""
