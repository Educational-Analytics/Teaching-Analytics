...
legend_order_Adapted_FR = c('Difficulté Adapté', 'Difficulté Non-Adapté') #Order of the Legend in French.
...
#Set the Figure file name and Figure size, margins and positions of the graphs
png(paste("../Figures/Vrs_Français/", fig_Sequences_mod3chap2_P_R_PR, ".png", sep = ""), heigh = 800, width = 1800)
