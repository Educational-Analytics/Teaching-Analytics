...
depts_type = ['Droit', 'Economie', 'Marketing', 'Informatique', 'Mathématiques', 'Philosophie', 'Sociologie'] #Define a list of Departements
modules = [
...
Quizzes_db['Department'] = Quizzes_db['Departement'].replace(
                            ['Droit', 'Economie', 'Marketing', 'Informatique', 'Mathématiques', 'Philosophie', 'Sociologie'],
