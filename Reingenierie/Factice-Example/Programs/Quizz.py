...
depts_type = ['Droit', 'Economie', 'Information-Communication', 'Informatique', 'Mathematique', 'Philosophie', 'Sociologie'] #Define a list of Departements
modules = [
    ...
    ["Introduction a l'Etude du Langage", "Grammaire Lexicale Fonctionnelle", "Grammaire et Syntaxe", "Neologie", "Construction Morphologique"], #Information-Communication
    ["Generalites sur les Systeme Informatiques", "Les Logiciels", "Algorithme et Programmation", "Reseaux et Internet"], #Informatique
    ["L'Algebre Lineaire", "Le Calcul d'Integral", "La Derivation", "Les Espaces Pre-Hilbertiens et Hilbertiens", "La Geometrie Analytique"], #Mathematique
