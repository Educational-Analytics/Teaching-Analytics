...
```{r}
prep_Sequences_mod1chap1 <- prep_Sequences %>% filter(Departement == "Informatique" & Module_ID == 2 & Chapter_ID == 1)
...
seqiplot(mvad.Sequences_mod1chap2_DS, with.legend=FALSE, cpal = col_correct, ytlab=seq_Sequences_mod1chap2_DS$Year, ylas=0, cex.lab = 2.2, cex.axis = 2, space = 0.15, ylab = "Année", xlab = "Rang et Identification du Quiz dans la Séquence Pédagogique")

seqlegend(mvad.Sequences_mod1chap2_DS, cpal = col_correct, cex =2.5, position = 'center')
